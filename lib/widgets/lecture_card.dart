            ...
            ...List.generate(files.length, (index) {
              ...
              return Padding(
                padding: EdgeInsets.only(
                  bottom: index == files.length - 1 && !hasExam ? 0 : 9,
                ),
        ...
        return Material(
          ...
          child: Container(
            padding: EdgeInsets.fromLTRB(
              ...
              isTablet ? 11 : 9,
              isTablet ? 13 : 11,
              isDownloading ? 9 : isTablet ? 11 : 9,
            ),
            decoration: BoxDecoration(
              color: theme.colorScheme.surface,
              borderRadius: BorderRadius.circular(isTablet ? 16 : 14),
              border: Border.all(
                color: theme.colorScheme.onSurface.withValues(alpha: 0.075),
              ),
              boxShadow: [
                BoxShadow(
