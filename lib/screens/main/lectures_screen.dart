...
class _LecturesScreenState
    extends State<LecturesScreen> {
  final SupabaseClient _supabase =
      Supabase.instance.client;

  late Future<List<_Lecture>>
      _lecturesFuture;
  ...
  Future<bool>
    ...
    final shouldWarn =
        await StudentPreferencesService
            .instance
      ...
      builder:
        ...
        return AlertDialog(
          ...
          content:
            ...
            children: [
              Text(
                'You are currently using mobile data.',
                style:
                    const TextStyle(
                  fontWeight:
                      FontWeight
              ...
              Text(
                'Downloading "${file.title}" may use part of your mobile data allowance.',
                style:
                    TextStyle(
                  color:
                      dialogTheme
                ...
                child:
                  ...
                  children: [
                    ...
                    Expanded(
                      child:
                          Text(
                        'Continue only if you are comfortable using mobile data.',
                      ),
                    ),
                  ],
                ),
  ...
  Future<void> _downloadFile(
    ...
    try {
        ...
        final shouldOpen =
          ...
          builder:
            ...
            return AlertDialog(
              ...
              content:
                  Text(
                '"${file.title}" is already available offline.',
              ),
              actions: [
                TextButton(
                  onPressed:
      ...
      final canContinue =
          await _confirmMobileDataDownload(
        file,
      );
      ...
      final downloaded =
        ...
        onProgress:
          ...
          debugPrint(
            'Downloading ${file.title}: $percent%',
          );
        },
      );
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          SnackBar(
            content:
                Text(
              '${downloaded.title} downloaded successfully.',
            ),
            action:
                SnackBarAction(
              label:
