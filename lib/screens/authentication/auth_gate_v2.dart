...
class _AuthGateV2State extends State<AuthGateV2> {
  ...
  Future<void> _initNotifications() async {
    if (_notificationStarted || !widget.settings.notificationsEnabled) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    if (s.forceUpdate) {
      return _RemoteBlock(
        ...
        message:
            'A newer version of ${s.appName} is required. Please update the app to continue.',
    ...
    if (session == null) {
      return _StudentLoginEntry(allowRegistration: s.allowRegistration);
    }
    ...
    if (s.homeAnnouncement.trim().isEmpty) {
      return shell;
    }
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(icon, size: 56, color: s.primary),
